...
export const deployApi = { trigger: d => api.post('/deploy/trigger', d), getStatus: id => api.get(`/deploy/status/${id}`), getLogs: id => api.get(`/deploy/logs/${id}`), getHistory: () => api.get('/deploy/history'), remove: id => api.delete(`/deploy/${id}`), download: d => api.post('/deploy/download', d, { responseType: 'blob' }) };
export default api;
